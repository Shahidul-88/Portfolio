...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <section class="section" id="contact">
        <div class="container text-center">
            ...
            <!-- contact form -->
            <form action="{{route('send.message')}}" method="POST" class="contact-form col-md-10 col-lg-8 m-auto">
                @csrf 
                    @if (session('success'))
                ...
                <div class="form-row">                                    
                        <div class="form-group col-sm-6">
                            <input name="name" type="text" size="50" class="form-control" placeholder="Your Name">
                        </div>
                        <div class="form-group col-sm-6">
