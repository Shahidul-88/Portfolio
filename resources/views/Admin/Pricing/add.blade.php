    ...
    <div class="col-lg-8 m-auto">    
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                <form action="{{route('insert.pricing.premium')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="">Pricing Image</label>
                        <input type="file" name="pricing_image" class="form-control">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <table class="table table-striped">
                    ...
                    @forelse ($premium_prices as $key=> $pre)
                        <tr>
                            <td>{{$key + 1}}</td>
                            <td><img src="{{asset('Uploads/pricing')}}/{{$free->pricing_image}}" alt=""></td>
                            <td>{{$pre->pricing_name}}</td>
                            <td>{{$pre->pricing_service}}</td>
                            <td>{{$pre->pricing_rate}}</td>
                            <td>
                                <a href=""><i class="mr-3 fa-sharp fa-solid fa-pen-to-square"></i></a>
