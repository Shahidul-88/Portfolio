		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					<img src="{{asset('Dashboard/img/logo.svg')}}" alt="navbar brand" class="navbar-brand">
				</a>
								...
								<li>
									<div class="message-notif-scroll scrollbar-outer">
										<div class="notif-center">
											...
											<a href="#">
												<div class="notif-img"> 
													<img src="{{asset('Frontend/img/chadengle.jpg')}}" alt="Img Profile">
												</div>
												<div class="notif-content">
								...
								<div class="avatar-sm">
									<div class="col-md-3 text-center mb-5">
										<div  class="avatar avatar-xl">
											...
											@else
											<img style="width: 40px; height:40px;margin-left:-50px" src="{{asset('Uploads/users/')}}/{{Auth::user()->photo}}" alt="..." class="avatar-img rounded-circle">
											@endif
									...
									<li>
										<div class="user-box">
											<div class="avatar-lg">
												<div  class="avatar avatar-xl">
											@if(Auth::user()->photo == null)
											<img style="width:50px;" src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" />
											@else
											<img style="width: 60px; height:60px;" src="{{asset('Uploads/users')}}/{{Auth::user()->photo}}" alt="..." class="avatar-img rounded-circle">
											@endif
				...
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2">
							 <div  class="avatar avatar-xl">
e 								@if(Auth::user()->photo == null)
								<img style="width:40px;" src="{{ Avatar::create(Auth::user()->name)->toBase64() }}" />
								@else
								<img style="width: 50px; height:50px; margin-left:-20px" src="{{asset('Uploads/users/')}}/{{Auth::user()->photo}}" alt="..." class="avatar-img rounded-circle">
								@endif
